...
import {CustomersListRequest, DeleteCustomerRequest} from "../../APIRequest/CustomerAPIRequest.js";
...
const CustomerList = () => {
    ...
    const handlePageClick = async (event) => {
        await CustomersListRequest(event.selected + 1, perPage, searchKeyword)
    };
