                                ...
                                <div className="container-fluid">
                                    <div className="row">
                                        ...
                                        <div className="col-6 col-md-3 pt-2">
                                            <Link to={'/SupplierCreateUpdatePage'} className="btn px-3 px-lg-4 btn-success text-xxs">Create New</Link>
                                        </div>
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr key={i}>
                                                                ...
                                                                <td><p className="text-xs text-start">{item.SupplierName}</p></td>
